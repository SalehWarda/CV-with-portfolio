...
<!-- ======= Hero Section ======= -->
<section id="hero" class="d-flex flex-column justify-content-center" style="background-image: url({{$home->photo}})">
    <div class="container" data-aos="zoom-in" data-aos-delay="100">
        <h1>{{$home->name}}</h1>
        <p>I'm <span class="typed" data-typed-items="{{$home->jobs}}"></span></p>
        <div class="social-links">

            @foreach($socials as $social)

                <a href="{{$social->link}}" class="{{$social->name}}"><i class="bx bxl-{{$social->icon}}"></i></a>
...
<main id="main">
    ...
    <section id="about" class="about">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <img src="{{ url($about->photo) }}" class="img-fluid" alt="">
                </div>
                        ...
                        <div class="col-lg-6">
                            <ul>
                                <li><i class="bi bi-chevron-right"></i> <strong>Name:</strong>
                                    <span>{{$about->name}}</span></li>
                                <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong>
                                    <span>{{$about->birthday}}</span></li>
                                <li><i class="bi bi-chevron-right"></i> <strong>Call:</strong>
                                    <span>{{$about->phone}}</span></li>
                                <li><i class="bi bi-chevron-right"></i> <strong>Nationality:</strong>
                                    <span>{{$about->nationality}}</span></li>
                                <li><i class="bi bi-chevron-right"></i> <strong>City:</strong>
                                    <span>{{$about->address}}</span></li>
                            </ul>
                        </div>
                        <div class="col-lg-6">
                            <ul>
                                ...
                                <li><i class="bi bi-chevron-right"></i> <strong>Spoken:</strong>
                                    <span> {{$about->spoken}}</span></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="count-box">
                        ...
                        <span data-purecounter-start="0" data-purecounter-end="{{ $fact->clients }}" data-purecounter-duration="1"
                ...
                <div class="col-lg-3 col-md-6 mt-5 mt-md-0">
                    <div class="count-box">
                        ...
                        <span data-purecounter-start="0" data-purecounter-end="{{ $fact->projects }}" data-purecounter-duration="1"
                              class="purecounter"></span>
                        <p>Projects</p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
                    <div class="count-box">
                        ...
                        <span data-purecounter-start="0" data-purecounter-end="{{ $fact->h_o_s }}" data-purecounter-duration="1"
                              class="purecounter"></span>
                ...
                <div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
                    <div class="count-box">
                        ...
                        <span data-purecounter-start="0" data-purecounter-end="{{ $fact->y_o_e }}" data-purecounter-duration="1"
                              class="purecounter"></span>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="progress">
                        ...
                        <div class="progress-bar-wrap">
                            <div class="progress-bar" role="progressbar" aria-valuenow="{{ $skills->l_o_e }}" aria-valuemin="0"
                    ...
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-info">
                            ...
                            <div class="portfolio-links">
                                <a href="{{$portfolio->images[0]->photo ?? ''}}" data-gallery="portfolioGallery"
                                   class="portfolio-lightbox" title="{{ $portfolio->name }}"><i class="bx bx-plus"></i></a>
                                <a href="{{route('portfolio.details',$portfolio->id)}}" class="portfolio-details-lightbox"
            ...
            <div class="row mt-1">
                ...
                <div class="col-lg-8 mt-5 mt-lg-0">
                    ...
                    <form action="{{ route('contact-us.store') }}" method="post" role="form" class="php-email-form">
                        ...
                        @csrf
                        @include('includes.alerts.alertContact')
...
<footer id="footer">
    <div class="container">
        ...
        <div class="copyright">
            &copy; Copyright <strong><span><a href="https://bootstrapmade.com/" target="_blank">BootstrapMade</a></span></strong>. All Rights Reserved
        </div>
        <div class="credits">

            Develped by <a href="#">Saw</a>
        </div>
    </div>
</footer><!-- End Footer -->
